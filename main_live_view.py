...
def setup_gpio():
    ...
    GPIO.add_event_detect(mode_button, GPIO.RISING, callback=toggle_image_mode, bouncetime=400)
    GPIO.add_event_detect(record_button, GPIO.RISING, callback=toggle_recording, bouncetime=20)
